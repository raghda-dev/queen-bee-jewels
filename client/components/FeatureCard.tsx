...
type FeatureCardProps = {
  ...
  const FeatureCard: React.FC<FeatureCardProps> = ({ icon, feature, description }) => {
    return (
      <div className="feature-card bg-white flex flex-col items-center justify-center px-4 py-4 h-[42vh] lg:h-[44vh] w-[100vw] min-w-[20rem] max-w-[5rem] xs:w-[70vw] xs:min-w-[22rem] xs:max-w-[10rem] md:w-[20vw] md:min-w-[19.2rem] lg:w-[50vw] lg:max-w-[10rem] lg:min-w-[23rem] rounded-md mb-5">
        <div className="flex flex-col items-center justify-evenly h-[80%] w-[90%] text-center">
