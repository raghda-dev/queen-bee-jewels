...
//       const refreshed = sessionStorage.getItem('has-refreshed');

//       if (!refreshed) {
//         sessionStorage.setItem('has-refreshed', 'true');

//         let fallback = localStorage.getItem('previousPath') || '/home';
//         if (fallback.startsWith('/home/settings') || fallback.startsWith('/home/cart')) {
//           fallback = '/home';
//         }
...
//   if (!children || !hasRefreshed) return null;
