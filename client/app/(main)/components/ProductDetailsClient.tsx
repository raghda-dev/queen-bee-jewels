...
export default function ProductDetailsClient({
  ...
  const viewImages = [
    displayedProduct.viewImage1,
    displayedProduct.viewImage2,
    displayedProduct.viewImage3,
  ];
  ...
  return (
    <div>
      ...
      <div className="flex w-full flex-col items-center overflow-hidden px-4 py-8 md:px-8">
